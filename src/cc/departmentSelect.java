...
public class departmentSelect extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        type.setBackground(new java.awt.Color(0, 0, 255));
        type.setFont(new java.awt.Font("Arial Rounded MT Bold", 1, 30)); // NOI18N
        type.setForeground(new java.awt.Color(0, 204, 51));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Object utype = type.getSelectedItem();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(departmentSelect.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
